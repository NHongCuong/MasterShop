                    ...
                    <div v-else>
                        <div class="d-flex">
                            ...
                            <div class="position-relative btn hover">
                                <span id='count_product_in_cart' style="width:25px;height:25px;top: -10px;left: -12px;" class="position-absolute bg-danger text-light rounded-circle text-center">
                                1</span>
                                
                                <router-link to="/cart">
                                    <img width="35" height="35" src="https://img.icons8.com/ios/50/shopping-cart--v1.png" alt="shopping-cart--v1"/>
                                </router-link>
                            </div>
                            <div class="dropdown d-flex">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li v-if="user?.userType.name == 'admin' || user?.userType.name == 'seller'"><a class="dropdown-item " href="/admin/dashboard">Trang quản trị</a></li>
                                    <li><router-link class="dropdown-item " to="/profile/{{session('id_user')}}">Thông tin cá nhân</router-link></li>
                                    <li @click="logOut()"> <button class="btn btn-light">Đăng xuất</button></li>
                                </ul>
