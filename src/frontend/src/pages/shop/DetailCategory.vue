      ...
      <div class="col-lg-7 w3-animate-bottom">
        <div class="pl-3 ml-3">
          ...
          <div v-if="myProduct">
              ...
              <div class="col-auto">
                <div class="input-group" style="width:50%">
                  <span class="input-group-btn">
                    <button class="btn btn-white btn-minuse" @click="changeAmount"
                                                type="button">-</button>
                  </span>
                  <input v-model="form.Amount" type="text"
                         class="form-control no-padding add-color text-center height-25" maxlength="3">
                  <span class="input-group-btn">
                    <button class="btn btn-red btn-pluss" @click="changeAmount"
                                                type="button">+</button>
                  </span>
                </div>
              </div>
            ...
            <div class="row mt-3">
              <button class="btn btn-primary" @click="AddCart"><i class="fas fa-shopping-cart mr-2"></i>Add to cart
              </button>

              <button @click="BuyNow" class="btn btn-success ml-3" :disabled="myProduct.amount <= 0" value="Buy now"
                      type="submit">Buy now
              </button>
