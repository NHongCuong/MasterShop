...
<template>
  ...
  <div class="menu-product container bg-light rounded pt-2 mt-3 change-background" data-background="#9adbf6"
  ...
  <div class="container bg-light rounded pt-2 mt-3 change-background" data-background="#f6d9d9">
    ...
    <div v-else class="row w-100">
      ...
      <div v-for="pr in products"
           class="col-md-2 col-sm-6 bg-light pt-3 border-end border-2 rounded rounded-3 w3-animate-bottom-08 mt-3 mb-4">
        <div class="product-grid2">
          ...
          <div class="product-content">
            <h3 class="title">
              <router-link :to="'/product/' + pr.id">{{ pr.name }}</router-link>
            </h3>
